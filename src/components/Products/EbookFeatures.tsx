...
const EbookFeatures: React.FC = () => {
  const features = [
    ...
    {
      icon: '🎯',
      title: 'Otimização para Sistemas ATS',
  ...
  const stats = [
    { number: '95%', label: 'Conteúdo Atualizado' },
    { number: '3x', label: 'Formatos Diversos' },
    { number: '48h', label: 'Acesso Vitalício' },
    { number: '10k+', label: 'Ebooks Criados' }
  ];
  ...
  return (
    <FeaturesContainer>
      <FeaturesContent>
        ...
        >
          <SectionTitle>
            Por que escolher o Ebook?
          </SectionTitle>
          <SectionSubtitle>
            Descubra as vantagens únicas que fazem do nosso Ebook a escolha inteligente para impulsionar seu conhecimento.
          </SectionSubtitle>
        </motion.div>
